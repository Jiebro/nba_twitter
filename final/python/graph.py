...
seventy_sixers_data_path = '76ers.txt'
...
postive = go.Bar(
                x=['Cavaliers', 'Raptors', '76ers', 'Mavericks'],
                y=[len(cavs_pos), len(raptors_pos), len(seventy_sixers_pos), len(mavs_pos)],
                name='Positive'
                )
negative = go.Bar(
                x=['Cavaliers', 'Raptors', '76ers', 'Mavericks'],
                y=[len(cavs_neg), len(raptors_neg), len(seventy_sixers_neg), len(mavs_neg)],
                name='Negative'
                )
